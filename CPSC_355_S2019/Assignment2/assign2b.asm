 ...
 * Description:
 *
 * Assignment2 Version2: Integer Multiplication using Add and Shift Operations
 *
 ...
 * readable. In version2, the initial value of multiplicand is 522133279, the initial
 * value of multiplier is 200.
 */
...
fmt2:       .string "64-bit result = 0x%016lx (%ld)\n"                          // The string for printing out 64-bit result
            ...
            .balign 4                                                           // Ensure all following instructions are properly aligned
...
main:       stp     fp, lr, [sp, -16]!                                          // Save Frame Pointer and Link Register to the Stack Pointer
            ...
            mov     multiplicand_r, 522133279                                   // Set the value in multiplicand_r as 522133279
            mov     multiplier_r, 200                                           // Set the value in multiplier_r as 200
