 ...
 * Description:
 *
 * Assignment2 Version1: Integer Multiplication using Add and Shift Operations
 *
...
main:       stp     fp, lr, [sp, -16]!                                          // Save Frame Pointer and Link Register to the Stack Pointer
            ...
            mov     multiplicand_r, -16843010                                   // Set the value in multiplicand_r as -16843010
            mov     multiplier_r, 70                                            // Set the value in multiplier_r as 70
