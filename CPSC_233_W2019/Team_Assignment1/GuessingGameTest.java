...
public class GuessingGameTest {
    ...
    public void test_InvalidGuess0() {
        ...
        if (lines == null || lines.length != 3) {
            fail("For the team exercise, we should be reprompted on invalid guess.  In this case third entry is correct so expecting three prompt lines and errors.");
        }
        if (!lines[0].contains(":")) {
            fail("The program did not produce the correct output. There was no colon (':') which is required after the prompt.");
        }
        ...
        // For team assignment: add test that we'll be reprompted on incorrect guess.
        actualMessage = lines[1].split(":")[1];
        actualMessage = actualMessage.trim();
        assertEquals("2nd time: Testing message. The number to guess was 11 and guess provided was 0.", expectedMessage, actualMessage);
        assertEquals("2nd time: Testing return value. The number to guess was 11 and guess provided was 0.", expected, actual);

        actualMessage = lines[2].split(":")[1];
        actualMessage = actualMessage.trim();
        expectedMessage = "Too low";
        assertEquals("3rd time: Testing message. The number to guess was 11 and guess provided was 1.", expectedMessage, actualMessage);
        assertEquals("3rd time: Testing return value. The number to guess was 11 and guess provided was 1.", expected, actual);
    }

    @Test
    public void test_InvalidGuess21() {
        String[] lines = {"21", "25", "27", "0", "-10", "15"};
        ...
        if (lines == null || lines.length != 6) {
            fail("For the team exercise, we should be reprompted on invalid guess.  In this case sixth entry is valid so expecting three prompt lines and errors.");
        }
        if (!lines[0].contains(":")) {
            fail("The program did not produce the correct output. There was no colon (':') which is required after the prompt.");
        }
        ...
        actualMessage = lines[1].split(":")[1];
        actualMessage = actualMessage.trim();
        assertEquals("2nd time: Testing message. The number to guess was 20 and guess provided was 25.", expectedMessage, actualMessage);
        assertEquals("2nd time: Testing return value. The number to guess was 20 and guess provided was 25.", expected, actual);

        actualMessage = lines[2].split(":")[1];
        actualMessage = actualMessage.trim();
        assertEquals("3rd time: Testing message. The number to guess was 20 and guess provided was 27.", expectedMessage, actualMessage);
        assertEquals("3rd time: Testing return value. The number to guess was 20 and guess provided was 27.", expected, actual);

        actualMessage = lines[3].split(":")[1];
        actualMessage = actualMessage.trim();
        assertEquals("4th time: Testing message. The number to guess was 20 and guess provided was 0.", expectedMessage, actualMessage);
        assertEquals("4th time: Testing return value. The number to guess was 20 and guess provided was 0.", expected, actual);

        actualMessage = lines[4].split(":")[1];
        actualMessage = actualMessage.trim();
        assertEquals("5th time: Testing message. The number to guess was 20 and guess provided was -10.", expectedMessage, actualMessage);
        assertEquals("5th time: Testing return value. The number to guess was 20 and guess provided was -10.", expected, actual);

        actualMessage = lines[5].split(":")[1];
        actualMessage = actualMessage.trim();
        expectedMessage = "Too low";
        assertEquals("6th time: Testing message. The number to guess was 20 and guess provided was 15.", expectedMessage, actualMessage);
        assertEquals("6th time: Testing return value. The number to guess was 20 and guess provided was 15.", expected, actual);
    }
