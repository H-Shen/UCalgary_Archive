...
public class Validation {
    ...
    public static boolean isRoleValid(String role) {
        ...
        System.out.println(Constants.COLOR_WRAPPER("The ROLE must be ADMIN or FACULTY or STUDENT!", Constants.RED));
        return false;
    }
    ...
    public static boolean isUsernameValid(String username) {
        ...
        if (username.trim().isEmpty()) {
            ...
            System.out.println(Constants.COLOR_WRAPPER("The username cannot be empty or contain whitespaces only!", Constants.RED));
            return false;
        }
        ...
        for (int i = 0; i < username.length(); ++i) {
            if (!Constants.LEGAL_USERNAME_CHARSET.contains(username.charAt(i))) {
                ...
                System.out.println(Constants.COLOR_WRAPPER("The username can only contain spaces, underscores, " +
        ...
        if (Database.usernameToUuid.containsKey(username)) {
            ...
            System.out.println(Constants.COLOR_WRAPPER("The username is being used!", Constants.RED));
            return false;
        }
        if (username.length() > Constants.MAX_USERNAME_LENGTH) {
            // pop out an error message if the length of username is greater than 20
            System.out.println(Constants.COLOR_WRAPPER("The length cannot be greater than 20!", Constants.RED));
            return false;
        }
        if (username.length() < Constants.MIN_USERNAME_LENGTH) {
            // pop out an error message if the length of username is smaller than 4
            System.out.println(Constants.COLOR_WRAPPER("The length cannot be smaller than 4!", Constants.RED));
            return false;
        }
        return true;
    }
    ...
    public static boolean isFullNameValid(String fullName) {
        ...
        if (fullName.length() < Constants.MIN_FULL_NAME_LENGTH) {
            ...
            System.out.println(Constants.COLOR_WRAPPER("The length cannot be smaller than 3!", Constants.RED));
            return false;
        }
        if (fullName.length() > Constants.MAX_FULL_NAME_LENGTH) {
            // pop out an error message if the length of full name is greater than 40
            System.out.println(Constants.COLOR_WRAPPER("The length cannot be greater than 40!", Constants.RED));
            return false;
        }
        ...
        for (int i = 0; i < fullName.length(); ++i) {
            ...
            System.out.println(Constants.COLOR_WRAPPER("Full name must only contain uppercase letters and whitespaces!",
                    Constants.RED));
            return false;
        }
        ...
        if (!hasUpperCase) {
            ...
            System.out.println(Constants.COLOR_WRAPPER("Full name must contain at least one uppercase letter!",
                    Constants.RED));
            return false;
        }
        ...
        if (!fullName.trim().equals(fullName)) {
            ...
            System.out.println(Constants.COLOR_WRAPPER("Full name must not contain leading or trailing whitespaces!",
                    Constants.RED));
            return false;
        }
    ...
    public static boolean isGenderValid(String gender) {
        ...
        if (!gender.equals(Constants.GENDER[0]) && !gender.equals(Constants.GENDER[1])) {
            ...
            System.out.println(Constants.COLOR_WRAPPER("Gender must be M or F!", Constants.RED));
            return false;
        }
    ...
    public static boolean isYearValid(String year) {
        ...
        if (temp.compareTo(Constants.MIN_YEAR) < 0) {
            ...
            System.out.println(Constants.COLOR_WRAPPER("Year must be not smaller than 1900!", Constants.RED));
            return false;
        }
        if (temp.compareTo(Constants.CURRENT_YEAR) > 0) {
            // pop out an error message if the year > current year
            System.out.println(Constants.COLOR_WRAPPER("Year must be not greater than current year!", Constants.RED));
            return false;
        }
    ...
    public static boolean isMonthValid(String month) {
        ...
        if (!Constants.VALID_MONTH.contains(month)) {
            ...
            System.out.println(Constants.COLOR_WRAPPER("Month out of range or invalid format(month < 10 must contain " +
    ...
    public static boolean isDayValid(String year, String month, String day) {
        ...
        if (day.length() != legalDayLength || !isInteger(day)) {
            ...
            System.out.println(Constants.COLOR_WRAPPER("Day is in invalid format(day < 10 must contain " +
                    "exactly 1 leading zero)!", Constants.RED));
            return false;
        } else {
            ...
            System.out.println(Constants.COLOR_WRAPPER("Day is out of range!", Constants.RED));
            return false;
        }
    }
     ...
     * 3. email address only contains letters, digits, dashes, underlines, dots, @
    ...
    public static boolean isEmailAddressValid(String emailAddress) {
        ...
        if (emailAddress.length() > Constants.MAX_EMAIL_ADDRESS_LENGTH) {
            ...
            System.out.println(Constants.COLOR_WRAPPER("Email address should not be longer than 40!", Constants.RED));
            return false;
        }
        ...
        for (int i = 0; i < emailAddress.length(); ++i) {
            ...
            System.out.println(Constants.COLOR_WRAPPER("Email address contains illegal characters!", Constants.RED));
            return false;
        }
        ...
        if (!Constants.EMAIL_ADDRESS_REGEX.matcher(emailAddress).matches()) {
            ...
            System.out.println(Constants.COLOR_WRAPPER("Email address format invalid!", Constants.RED));
            return false;
        }
    ...
    public static boolean isPhoneNumberValid(String phoneNumber) {
        ...
        if (!Constants.PHONE_NUMBER_REGEX.matcher(phoneNumber).matches()) {
            ...
            System.out.println(Constants.COLOR_WRAPPER("Phone number format invalid!", Constants.RED));
            return false;
        }
    ...
    public static boolean isAddressValid(String address) {
        ...
        if (address.isEmpty()) {
            ...
            System.out.println(Constants.COLOR_WRAPPER("Address cannot be empty!", Constants.RED));
            return false;
        }

        if (address.length() > Constants.MAX_ADDRESS_LENGTH) {
            // pop out an error message if the length of address > 80
            System.out.println(Constants.COLOR_WRAPPER("The length of address cannot be longer than 80!",
                    Constants.RED));
            return false;
        }
        ...
        for (int i = 0; i < address.length(); ++i) {
            ...
            System.out.println(Constants.COLOR_WRAPPER("The address can only contains letters, digits, spaces, dashes" +
                            ", dots and commas!",
                    Constants.RED));
            return false;
        }
    ...
    public static boolean isPasswordValid(String password) {
        ...
        if (password.length() < Constants.MIN_PASSWORD_LENGTH) {
            ...
            System.out.println(Constants.COLOR_WRAPPER("The length of password cannot be longer than 6!",
                    Constants.RED));
            return false;
        }
     ...
     * 4. it contains uppercase letters and digits only
    ...
    public static boolean isCourseIdValid(String courseId) {
        ...
        if (courseId.isEmpty()) {
            ...
            System.out.println(Constants.COLOR_WRAPPER("The course Id cannot be empty!", Constants.RED));
            return false;
        }
        if (Database.courses.containsKey(courseId)) {
            // pop out an error message if courseId does not exist in the database
            System.out.println(Constants.COLOR_WRAPPER("The course Id exists already!", Constants.RED));
            return false;
        }
        if (courseId.length() > Constants.MAX_COURSE_ID_LENGTH) {
            // pop out an error message if length of courseId is longer than 10
            System.out.println(Constants.COLOR_WRAPPER("The length of course Id cannot be longer than 10!",
                    Constants.RED));
            return false;
        }

        if (!Constants.COURSE_ID_REGEX.matcher(courseId).matches()) {
            System.out.println(Constants.COLOR_WRAPPER("The course Id does not satisfy the format!", Constants.RED));
            return false;
        }
    ...
    public static boolean isCourseNameValid(String courseName) {
        ...
        if (courseName.isEmpty()) {
            ...
            System.out.println(Constants.COLOR_WRAPPER("The course name cannot be empty!", Constants.RED));
            return false;
        }
        return true;
    }
    ...
    public static boolean isCourseDescriptionValid(String courseDescription) {
        ...
        if (courseDescription.isEmpty()) {
            ...
            System.out.println(Constants.COLOR_WRAPPER("The course description cannot be empty!", Constants.RED));
            return false;
        }
        return true;
    }
    ...
    public static boolean isCourseUnitsValid(String courseUnits) {
        ...
        if (!result) {
            ...
            System.out.println(Constants.COLOR_WRAPPER("The format of course units is invalid!", Constants.RED));
        }
     ...
     * 1. it can be converted to a number
     * 2. it has no redundant leading zeroes or trailing zeroes, cases like '0.0' are invalid
    ...
    public static boolean isPrerequisitesValid(String prerequisites) {
        ...
        if (!prerequisites.equals(prerequisites.trim())) {
            ...
            System.out.println(Constants.COLOR_WRAPPER("The course units cannot contain redundant leading or " +
        ...
        if (!temp.isEmpty()) {
            for (String i : temp) {
                if (!Database.courses.containsKey(i) && !i.equals(Constants.CONSENT_BY_DEPARTMENT)) {
                    ...
                    System.out.println(Constants.COLOR_WRAPPER("The course " + i + " does not exist!",
                            Constants.RED));
                    return false;
                }
            }
            ...
            if (tempArr.length != temp.size()) {
                ...
                System.out.println(Constants.COLOR_WRAPPER("The prerequisites contain duplicated courses!", Constants.RED));
                return false;
            }
        }
        return true;
     ...
     *
     * @param antirequisites a String containing the anitrequisites being checked.
     * @return true if antirequisites is valid as a hashset, false otherwise.
     */
     ...
     * @return true if antirequisite of a course is valid, false otherwise
     */
    public static boolean isAntirequisitesValidAsAString(String antirequisites) {
        ...
        if (!temp.isEmpty()) {
            ...
            if (tempArr.length != temp.size()) {
                ...
                System.out.println(Constants.COLOR_WRAPPER("The antirequisites contain duplicated courses!",
                        Constants.RED));
                return false;
            }
        }
    ...
    public static boolean isCanBeRepeatedValid(String canBeRepeated) {
        ...
        if (!canBeRepeated.equals(Constants.RESPONSE_YES) && !canBeRepeated.equals(Constants.RESPONSE_NO)) {
            ...
            System.out.println(Constants.COLOR_WRAPPER("The answer must be 'YES' or 'NO'!", Constants.RED));
            return false;
        }
    ...
    public static boolean satisfyPrerequisites(Student student, String courseId) {
        ...
        for (String i : prerequisites) {
            if (!allCourses.contains(i)) {
                System.out.println(Constants.COLOR_WRAPPER("You MUST take " + i + " before taking " + courseId + "!",
                        Constants.RED));
                return false;
            }
        }
    ...
    public static boolean satisfyAntirerequisites(Student student, String courseId) {
        ...
        for (String i : antirequisites) {
            if (allCourses.contains(i)) {
                System.out.println(Constants.COLOR_WRAPPER("You have taken or are taking " + i + " which is equivalent to " + courseId +
                        "!", Constants.RED));
                return false;
            }
        }
