...
public class Validation {
    ...
    // Validation of string of prerequisites
    ...
    public static boolean isPrerequisitesValid(ArrayList<HashSet<String>> prerequisites) {

        // Make sure the prerequisites is not null
        // Make sure there is no duplicated course.
        if (prerequisites != null) {
            ...
            return (tempArr.size() == tempSet.size());
        }
        return false;
    }
    ...
    public static boolean isAntirequisitesValid(String antirequisites) {
        ...
        if (antirequisites != null) {
            if (antirequisites.isEmpty()) {
                return true;
            } else {
                String[] temp = antirequisites.split(" ");
                for (String i : temp) {
