...
public class Database {
     ...
     * Database filepath
     */
    public static String ACCOUNT_DATA            = getDatabaseFilePath(false) + "ACCOUNT_DATA.db";
    public static String COURSES                 = getDatabaseFilePath(false) + "COURSES.db";
    public static String ACADEMIC_REQUIREMENTS   = getDatabaseFilePath(false) + "ACADEMIC_REQUIREMENTS_CPSC_BSC.db";
    public static String INTERNSHIP_REQUIREMENTS = getDatabaseFilePath(false) + "INTERNSHIP_REQUIREMENTS.db";
    public static String STUDENTS                = getDatabaseFilePath(false) + "STUDENTS.db";
    public static String FACULTY                 = getDatabaseFilePath(false) + "FACULTY.db";
    /**
    ...
    public static ArrayList<String>       optionalCourses  = new ArrayList<>();
        ...
        if (isValid(COURSES)) {
            ...
            try (Connection connection = createConnection(COURSES, true);
                ...
                while (resultSet.next()) {
                    ...
                    course.setPrerequisites(Course.pursePrerequisites(resultSet.getString("PREREQUISITES")));
                    course.setAntirequisites(Course.purseAntirequisites(resultSet.getString("ANTIREQUISITES")));
    ...
    public static void initializeAcademicRequirements() {
        ...
        String select = "SELECT * FROM OTHERS_ALL UNION SELECT * FROM MAJOR_FIELD_ALL UNION SELECT * FROM " +
                "MAJOR_FIELD_9UNITS UNION SELECT * FROM MAJOR_FIELD_12UNITS UNION SELECT * FROM MAJOR_FIELD_3UNITS;";
        ...
        select = "SELECT * FROM FACULTY_BREATH_REQUIREMENTS_18UNITS;";
        try (Connection connection = createConnection(ACADEMIC_REQUIREMENTS, true);
             Statement statement = connection.createStatement();
             ResultSet resultSet = statement.executeQuery(select)
        ) {
    ...
    public static void initializeFacultyInformation(String uuid) {
        ...
        try (Connection connection = createConnection(FACULTY, true);
            ...
            faculty.setCoursesTeaching(coursesTeaching);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public static void academicRequirementsUpdateCommit(String courseId) {
        // TODO
    }

    public static void internshipRequirementsUpdateCommit(String courseId) {
        // TODO
    }
    ...
    public static void academicRequirementsRemovalCommit() {
        // TODO
    }

    public static void internshipRequirementsRemovalCommit() {
        // TODO
    }
}
