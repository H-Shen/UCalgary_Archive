...
/**
 * The {@code ValidationTest} class for testing Validation class.
 *
 * @author Group 25
 * @date 2019/04/08
 */
public class ValidationTest {
    ...
    @Test
    public void test_isCourseUnitsValid_17() {
        assertFalse(Validation.isCourseUnitsValid("15.1"));
    }

    @Test
    public void test_isCourseUnitsValid_18() {
        assertTrue(Validation.isCourseUnitsValid("15"));
    }
