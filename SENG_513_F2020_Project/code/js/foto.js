//reference :https://github.com/kousik19/foto.js
...
class Foto {
    ...
    rotate(degrees){
        ...
        this.operationEditedCtx.drawImage(this.image, -this.image.width/2, -this.image.height/2);
        ...
        this.operationOrgCtx.drawImage(this.image, -this.image.width/2, -this.image.height/2);
    ...
    applyColorFilter(color) {
        ...
        this.generatePixelMatrix();
        this.previewImage();
        console.log("Apply Color Filter");
        console.log(this);
    }
